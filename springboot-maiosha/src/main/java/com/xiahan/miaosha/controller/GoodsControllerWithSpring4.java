...
import com.xiahan.miaosha.vo.GoodsDetailVo;
 ...
 * @Description: spring 4 版本手动渲染thymeleaf
 */
public class GoodsControllerWithSpring4 {
/*
    @Autowired
    ...
    public String detail2(HttpServletRequest request, HttpServletResponse response, Model model,MiaoshaUser user,
        ...
        long startAt = goods.getStartDate().toEpochSecond(ZoneOffset.of("+8"));
        long endAt = goods.getEndDate().toEpochSecond(ZoneOffset.of("+8"));
