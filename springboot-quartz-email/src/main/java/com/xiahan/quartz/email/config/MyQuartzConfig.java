package com.xiahan.quartz.email.config;
...
public class MyQuartzConfig {
	...
	@Bean
	@Order(20)
	public SchedulerFactoryBean schedulerFactory(@Qualifier(value = "dataSource") DataSource dataSource,JobFactory jobFactory) {
