...
public class AclUserRoleController {
    ...
    @Autowired
    AclUserRoleService persistentLoginsService;
    ...
    public Result info(@PathVariable("id") String id){
        AclUserRole persistentLogins = persistentLoginsService.getById(id);
        return Result.ok().data("persistentLogins", persistentLogins);
    }

    @PostMapping("/save")
    @ApiOperation(value = "新增数据")
    public Result save(@RequestBody AclUserRole persistentLogins){
    ...
    public Result update(@RequestBody AclUserRole persistentLogins){
