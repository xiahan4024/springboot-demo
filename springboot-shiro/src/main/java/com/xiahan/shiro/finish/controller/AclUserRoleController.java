...
import com.xiahan.shiro.finish.service.AclUserRoleService;
...
public class AclUserRoleController {
    ...
    @Autowired
    AclUserRoleService baseService;
    ...
    public Result info(@PathVariable("id") String id){
        AclUserRole baseEntity = baseService.getById(id);
        return Result.ok().data("baseEntity", baseEntity);
    }

    @PostMapping("/save")
    @ApiOperation(value = "新增数据")
    public Result save(@RequestBody AclUserRole baseEntity){
    ...
    public Result update(@RequestBody AclUserRole baseEntity){
